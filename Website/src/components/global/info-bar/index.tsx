    ...
    <header className="pl-20 md:pl-[265px] fixed p-4 w-full flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-4 ">
        <Button className="bg-[#9D9D9D] flex items-center gap-2 ">
          <UploadIcon size={20} className="text-black"/>{" "}
          <span className="flex items-center text-black gap-2">Upload</span>
        </Button>
        <Button className="bg-[#9D9D9D] flex items-center gap-2">
          <Video className="text-black"/>
          <span className="flex items-center text-black gap-2">Record</span>
        </Button>
        <UserButton />
      </div>
    </header>
